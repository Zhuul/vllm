...
`MODELSCOPE_CACHE` (default `/root/.cache/modelscope`). Update
`extras/configs/modelscope.env` to bind mount your host Podman volumes into the
dev container before running these helpers.
